...
const ITEMS = [
  ...
  { id: "portfolio",  label: "PORTFOLIO",   page: "portfolio",  fontSize: 68, offsetX: 8, offsetY: 6,  skew: 0, skewY: -4  },
...
export default function P3Menu({ onNavigate }) {
  ...
  useEffect(() => {
    const onKey = (e) => {
      ...
      if (e.key === "Enter") {
      if (ITEMS[active].id === "portfolio") {
      window.open("https://maghribiworks.framer.website/", "_blank");
      } else {
        ...
        <nav className="p3-menu">
          {ITEMS.map((item, i) => {
            ...
            return (
              ...
              window.open("https://maghribiworks.framer.website/", "_blank");
              } else if (item.id === "sideproj") {
              window.open("https://www.behance.net/GemaMaghribiii", "_blank");
              } else {
