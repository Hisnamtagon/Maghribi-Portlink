...
const ITEMS = [
  ...
  { id: "ii", badge: "II", title: "SKILLS", subtitle: "Design / Video / Dev", rank: 4 },
  { id: "iii", badge: "III", title: "PROJECTS", subtitle: "Featured Work", rank: 5 },
  { id: "iv", badge: "IV", title: "EXPERIENCE", subtitle: "Work History", rank: 2 },
];

const EDUCATION_ROWS = [
  { index: "01", title: "General Education", status: "Complete" },
  { index: "02", title: "Multimedia, vocational high school Dewantara", status: "Complete" },
  { index: "03", title: "Informatics Engineering, Universitas Indraprasta PGRI", status: "Complete" },
  { index: "04", title: "Dicoding Front-End Developer Certificate", status: "Complete" },
];

const SKILLS_ROWS = [
  { index: "01", title: "Illustrator, Photoshop, Canva", status: "Design" },
  { index: "02", title: "Premiere Pro, CapCut", status: "Video" },
  { index: "03", title: "After Effects", status: "Learning" },
  { index: "04", title: "Figma, HTML, CSS, JS", status: "UI/UX" },
];

const PROJECTS_ROWS = [
  { index: "01", title: "Portlink", status: "Complete" },
  { index: "02", title: "Portfolio Vol.2/Reload", status: "In Progress" },
  { index: "03", title: "Motion Graphic", status: "In Progress" },
];

const EXPERIENCE_ROWS = [
  { index: "01", title: "PT Prospek Vinet Cemerlang — Graphic Design", status: "2026" },
  { index: "02", title: "PT Solusi Berdaya Mandiri — Content Creation", status: "2024" },
  { index: "03", title: "Mitraruma — Video Editing", status: "2022–2023" },
...
const DETAIL_DATA = {
  i: {
    ...
    bullets: [
      ...
      "Track portfolio ready projects tied to coursework.",
  ...
  ii: {
    ...
    rows: SKILLS_ROWS,
    bullets: [
      "Design branding, layouts, and visual assets.",
      "Edit and produce video content for promos and social media.",
  ...
  iii: {
    ...
    rows: PROJECTS_ROWS,
    bullets: [
      "Built and shipped this portfolio site.",
      "Currently working on a new project.",
      "Producing a motion graphic, still in progress..",
    ],
  },
  iv: {
    ...
    bullets: [
      "Designs across three brands at PT Prospek Vinet Cemerlang.",
      "Edited home renovation and interior content at Mitraruma.",
      "Created promo and educational content for a pesantren laundry.",
    ],
  },
};
...
export default function ResumePage({ src }) {
  ...
  const detail = DETAIL_DATA[currentItem.id];
    ...
    <div id="menu-screen">
     ...
     @media (max-width: 768px) {
      ...
      <div className="resume-overlay">
       ...
       {revealed && detail && (
          <div className="resume-detail-panel" key={currentItem.id}>
            <div className="resume-detail-top">
              <div className="resume-detail-top-index">
                {String(active + 1).padStart(2, "0")}
              </div>
              <div className="resume-detail-top-title">{detail.title}</div>
              <div className="resume-detail-top-progress">
                {detail.rows.length}/{detail.rows.length}
              </div>
            </div>
