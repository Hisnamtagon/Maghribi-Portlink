...
const REVEAL_CONTENT = [
  {
    upper: ["name   : Gema Maghribi", "age:25"],
    lower: "major: Informatics Engineering  ",
  },
  {
    upper: [
      "Illustrator, Photoshop, and Premiere Pro are my daily drivers.",
      "Editing in Canva and CapCut when speed matters.",
      "Currently leveling up in After Effects",
    ],
    lower: "always learning, never really 'done",
  },
  {
    upper: [
      "1st place, Wirosableng video ads competition.",
      "2nd place, GrabFood video ads competition.",
    ],
    lower: "still chasing the next milestone",
  },
];
...
const ITEMS = [
    {
      id: "linkedin", label: "ABOUT ME", handle: "@yourname", href: "https://www.linkedin.com/in/gema-m-a3811829a/", icon: "💼", barIcon: icon1, bars: 1, newBars: [0], counts: ["100"],
      links: ["linkedin.com/in/gema-m-a3811829a/"],
      stats: [
        { tag: "FOL", value: "10", color: "#9147ff" },
        { tag: "PST", value: "0",  color: "#bf94ff" },
      ],
    },
    {
      id: "instagram", label: "TOOLS I USE", handle: "@yourhandle", href: "https://www.instagram.com/hnko._._/", icon: "📸", barIcon: icon2, bars: 5, newBars: [1, 2], counts: ["64", "63", "64", "40", "18"],
      links: ["instagram.com/p/DJ9Kz3CviiS/", "instagram.com/p/DJ9Kz3CviiS/", "instagram.com/p/DKcn51cvjiB/", "instagram.com/p/DEp_WdAztB2/", "instagram.com/p/DXSWMJIk2xI/"],
      stats: [
        { tag: "FOL", value: "215", color: "#e1306c" },
        { tag: "PST", value: "14",  color: "#f77737" },
      ],
    },
    {
      id: "tiktok", label: "ACHIEVEMENTS", handle: "@yourhandle", href: "https://www.tiktok.com/@hnko___", icon: "🎵", barIcon: icon3, bars: 6, newBars: [0, 1, 3, 5, 6], counts: ["919", "612", "828", "587", "357", "216", "791"],
      links: ["tiktok.com/@hnko___/photo/7546210745013439749", "tiktok.com/@hnko___/photo/7547712940867161400", "tiktok.com/@hnko___/photo/7630200317535063317", "tiktok.com/@hnko___/photo/7547356114266983736", "tiktok.com/@hnko___/photo/7531828884917062917", "tiktok.com/@hnko___/photo/7532439936344034616", "tiktok.com/@hnko___/photo/7545533923175025925"],
      stats: [
        { tag: "FOL", value: "54", color: "#00f2ea" },
        { tag: "LKS", value: "418",  color: "#ff0050" },
      ],
    },
  ];
